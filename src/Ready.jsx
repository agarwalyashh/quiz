...
function Ready({numQ,dispatch})
{
    ...
    return(
        <div className="text-white mt-10 grid gap-8">
            ...
            <button className="bg-gray-600 p-4 rounded-md w-36 place-self-center text-xl
             hover:bg-gray-900" onClick={()=>dispatch({type:'start'})}>Let&apos;s Start</button>
        </div>
    )
}
